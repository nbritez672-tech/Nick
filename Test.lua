...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    local CapsuleState = {Active = false, Connections = {}, Toggle = nil, DragZone = nil, OpenZone = nil}
    ...
    local function ApplyLogoIcon(iconName)
        ...
        if CapsuleState.Active then
            ...
            local pillHeight = iconData.Height or 58
            local handleWidth = iconData.HandleWidth or 58
            local iconSize = iconData.IconSize or 24

            ToggleButton.Size = UDim2.new(0, pillWidth, 0, pillHeight)
            ...
            mk("Frame", {
                ...
                BackgroundColor3 = Color3.fromRGB(44, 48, 58),
            ...
            local openConnection = CapsuleState.OpenZone.MouseButton1Click:Connect(function()
                if CapsuleState.Toggle then CapsuleState.Toggle() end
            end)
