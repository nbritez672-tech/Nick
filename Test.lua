        ...
        if iconData.Type == "Capsule" then
            ...
            do
                ...
                if _capStroke then
                    ...
                    --// de cada línea recta (arriba y abajo). Zona de fade ENSANCHADA (20% de
                    --// borde solido + 60% de fade en cada línea) y transparencia máxima subida
                    --// a 0.95 para que el efecto sea claramente visible, no sutil.
                    --// Geometría: rectángulo redondeado 185x42, radio 14.
                    local _capGrad = Instance.new("UIGradient")
                    _capGrad.Transparency = NumberSequence.new({
                        NumberSequenceKeypoint.new(0.0000, 0),
                        NumberSequenceKeypoint.new(0.0730, 0),
                        NumberSequenceKeypoint.new(0.1826, 0.95),  -- centro linea de arriba
                        NumberSequenceKeypoint.new(0.2922, 0),
                        ...
                        NumberSequenceKeypoint.new(0.5731, 0),
                        NumberSequenceKeypoint.new(0.6827, 0.95),  -- centro linea de abajo
                        NumberSequenceKeypoint.new(0.7923, 0),
