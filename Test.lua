        ...
        if iconData.Type == "Capsule" then
            ...
            do
                ...
                if _capStroke then
                    ...
                    --// un UIGradient con su Offset animado en loop infinito, en vez de posiciones
                    --// fijas del perímetro. Esto "recorre" el borde sin depender de calcular la
                    --// geometría exacta de las esquinas. Zona negra ENSANCHADA a pedido: la franja
                    --// brillante ocupa solo ~20% del recorrido (0.40 a 0.60), el resto queda oscuro.
                    ...
                    _capGrad.Transparency = NumberSequence.new({
                        NumberSequenceKeypoint.new(0.00, 0.9),
                        NumberSequenceKeypoint.new(0.40, 0.9),
                        NumberSequenceKeypoint.new(0.50, 0.05),  -- franja brillante, angosta
                        NumberSequenceKeypoint.new(0.60, 0.9),
