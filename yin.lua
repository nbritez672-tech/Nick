...
function YinYang:CreateWindow(title_text, startTheme)
    ...
    function Window:CreateTab(nameSpanish, nameEnglishOrIcon, iconAsset)
        ...
        function Tab:CreateFloatingToggle(textSpanish, textEnglishOrDefault, defaultOrCallback, callback)
            ...
            --// Botón Desprender — corrido a la izquierda para dar lugar a + y -
            ...
            --// Botón + (liberar drag del flotante)
            ...
            corner(PlusBtn, 4)
            stroke(PlusBtn, Theme.Stroke, 1, 0.5)

            --// Botón - (fijar/bloquear drag del flotante)
            ...
            corner(MinusBtn, 4)
            stroke(MinusBtn, Theme.Stroke, 1, 0.5)
            ...
            --// + = liberar drag | - = fijar posición
            PlusBtn.MouseButton1Click:Connect(function()
                isLocked = false
                playSound(Sounds.Click, 0.5)
                TweenService:Create(PlusBtn, TweenInfo.new(0.15),
            ...
            MinusBtn.MouseButton1Click:Connect(function()
                isLocked = true
                playSound(Sounds.Click, 0.5)
                TweenService:Create(MinusBtn, TweenInfo.new(0.15),
                    {BackgroundColor3 = Color3.fromRGB(200, 80, 80)}):Play()
                task.delay(0.3, function()
                    TweenService:Create(MinusBtn, TweenInfo.new(0.15),
                        {BackgroundColor3 = Theme.Secondary}):Play()
                end)
